<div class="wrap">
		<div class="col">
            <!--**************************************************** Вывод категории привязанного к пункту меню ***************************************************-->
			<p>
				<?php
					foreach($data as $value){					
						$nameCat = $value['name'];
						$contentCat = $value['content'];
						echo category($nameCat, $contentCat);
					}					
				?>
			</p>
			<!--***************************************************************************************************************************************************-->
			<div class='colBlog'>
                <!--************************************** Вывод материалов блога, прикремленных к категории и пункту пеню ****************************************-->
				<!--***********************************************************************************************************************************************-->
			</div>
		</div>
		<!--<div class="col">
		...
		<div class="col last">
			...
			<!--*********************************************************** Позиция вывода модуля ( 2 ) ***********************************************************-->
            <p class="info">TEST2222</p>
            <!--***************************************************************************************************************************************************-->
		</div>
</div>
